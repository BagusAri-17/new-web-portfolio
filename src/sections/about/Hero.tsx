...
const aboutParagraph = [
    "My name is Ida Bagus Ari Widhiana. You can call me Bagus Ari. I'm a graduate of Udayana University, majoring in Informatics Engineering, with expertise in Front-End Developer and UI/UX Designer.",
    "With a creative mindset and a keen eye for detail, I specialize in crafting delightful user experiences and bringing them to life through clean and efficient front-end development.",
                ...
                <div className="container">
                    <div className="flex gap-8 flex-col lg:flex-row lg:justify-between">
                        <div className="flex flex-col gap-y-8 max-w-2xl">
                            <h2 className="text-2xl md:text-4xl font-bold">Hi, I'm Bagus Ari</h2>
                        ...
                        <div>
                            <img className="rounded-xl sm:rounded-2xl h-auto transition duration-300 hover:scale-110" src="https://spotlight.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fimage-4.5c6d0ed6.jpg&w=640&q=75" alt="" width={400} height={400} />
                        </div>
                    </div>
                </div>
